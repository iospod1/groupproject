...
- [X] User can see list of teams in the Premier League standing in "Teams" page
- [X] User can see list of top scorers in "Players" page
- [X] User can see list of matches in "Match" page
- [X] User can Sign Up, Sign In and Logout of session.
- [X] API Working - obtained Parse Backend API Key, SportDataApp API key.
